...
public abstract class ErrorRecoveryMethodInjection extends Injection<MethodSite> {

    public ErrorRecoveryMethodInjection() {
        super(InjectionTarget.METHOD, InjectionDelta.MODIFICATION);
    }

    @Nullable
    public abstract Object tryRecovery(@Nullable Object thisInstance,
                                       Object[] params,
                                       Throwable error,
                                       MethodProxy proxy,
