...
public abstract class PostHookMethodInjection extends Injection<MethodSite> {

    public PostHookMethodInjection() {
        super(InjectionTarget.METHOD, InjectionDelta.MODIFICATION);
    }

    @Nullable
    public abstract Object hookReturn(@Nullable Object thisInstance,
                                      Object[] params,
                                      @Nullable Object originalReturn,
