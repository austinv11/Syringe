...
public abstract class ReplaceMethodInjection extends Injection<MethodSite> {

    public ReplaceMethodInjection() {
        super(InjectionTarget.METHOD, InjectionDelta.MODIFICATION);
    }

    @Nullable
    public abstract Object apply(@Nullable Object thisInstance,
                                 Object[] params,
